...
export default class App extends Component {
  ...
  submitHandler = e => {
    ...
    axios.post('https://sheet.best/api/sheets/879a79f3-8401-428a-b545-5fb5db3cc49f', this.state)
    .then(response => {
  ...
  getData = async() => {
    console.log('data');
    try {
      const res = await fetch('https://sheet.best/api/sheets/879a79f3-8401-428a-b545-5fb5db3cc49f');
